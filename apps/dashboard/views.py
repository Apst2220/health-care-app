...
def get_context_data(request):
    ...
    # context['health_stats_list'] = "hello world" # WorldHealthStatistics.objects.all()[:5]
    # return context
    return render(request, 'dashboard.html' , {'health_stats_map': "hello world"})
    
# class DashboardView(TemplateView):
#     template_name = "dashboard.html" # templates/home.html
...
#         return context
    ...
    # def health_dashboard_stats(self, request):
    #     health_stats_list = WorldHealthStatistics.objects.all()
    #     print("health_stats_list=", health_stats_list)
    #     logger.info(f"health_stats_list= {health_stats_list}")
    #     return render(request, "dashboard.html", {'health_stats_list': health_stats_list})
        # context = super().get_context_data(**kwargs)
        # db_data = WorldHealthStatistics.objects.all()[:5]
        # context['health_stats_list'] = db_data
        # logger.info(f"db_data={db_data}")
        # return context
    

#     # Step 1: Fix this
#     def health_dashboard_map(self, **kwargs):
#         context = super().get_context_data(**kwargs)
#         map = folium.Map([51.5, -0.25], zoom_start=10)
#         map = map._repr_html_()
#         context['health_stats_map'] = map
#         return context
...
#         # context['health_stats_map'] = world_map
#         return context
