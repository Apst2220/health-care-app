...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['latest_articles'] = WorldHealthStatistics.objects.all()[:5]
        return context
    ...
    def health_dashboard_map_final(request):
        ...
        if request.button[0] == "deaths_per_1lac_diabetes":
            ...
            world_map = create_map(map_name, legend_name, geo_df, col_name, sex)
